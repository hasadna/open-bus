...
Some Jupyter Notebook examples for working directtly with GTFS - [Playing with GTFS](https://cjer.github.io) / [github](https://github.com/cjer/open-bus-explore)
...
To get started, clone the repository, and have a look at [our issues](https://github.com/hasadna/open-bus/issues) and [the doc directory](https://github.com/hasadna/open-bus/blob/master/doc/), to see what we need help with. 
