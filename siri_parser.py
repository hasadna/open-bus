...
def _bus_node_to_bus_obj(bus_node):
    """
        Args:
        ...
        Returns:
            An object of type Bus with all the necessary information
    ...
    line_ref = _get_tag_text(line.LineRef)
...
def parse_siri_xml(response_xml):
    ...
    if busses:
        return [_bus_node_to_bus_obj(bus) for bus in busses]