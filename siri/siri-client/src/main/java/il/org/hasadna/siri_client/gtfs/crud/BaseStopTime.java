...
public final class BaseStopTime implements StopTime {
	...
	public static BaseStopTime parse(String csvRow) {
		...
		Iterator<String> iter = Arrays.asList(csvRow.split(",", -1))
				.iterator();
	...
	public BaseStopTime(String tripId, String arrivalTime, String departureTime, int stopId, int stopSequence,
